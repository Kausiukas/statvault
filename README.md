...
[![Next.js 14](https://img.shields.io/badge/Next.js-14.2.0_(App_Router)-000000?style=for-the-badge&logo=nextdotjs&logoColor=white)](https://nextjs.org/)
[![React Three Fiber](https://img.shields.io/badge/R3F-Three.js_WebGL-black?style=for-the-badge&logo=threedotjs&logoColor=white)](https://docs.pmnd.rs/react-three-fiber)
...
[![Strapi v4](https://img.shields.io/badge/Strapi-v4.20_(Headless_CMS)-2F2E8B?style=for-the-badge&logo=strapi&logoColor=white)](https://strapi.io/)
[![PostgreSQL](https://img.shields.io/badge/PostgreSQL-16-336791?style=for-the-badge&logo=postgresql&logoColor=white)](https://www.postgresql.org/)
[![Draco + KTX2](https://img.shields.io/badge/3D_Pipeline-Draco_%2B_KTX2_Basis-blueviolet?style=for-the-badge&logo=khronosgroup&logoColor=white)](https://www.khronos.org/gltf/)
[![Build Status](https://img.shields.io/badge/Build-Passing-brightgreen?style=for-the-badge&logo=githubactions&logoColor=white)](https://github.com/Kausiukas/statvault)
...
## 🌟 Daily Featured Dataslate: Assault Intercessor Squad
*Autonomous Ingestion Pipeline — Canonical Lore Research, Multi-View Asset Suite & Battlefield Concept Art*

<table>
  <tr>
    <td align="center">
      <img src="assets/art/space-marine-assault_concept.png" alt="Assault Intercessor Squad in Action" width="100%" style="border-radius: 8px;" />
      <br/>
      <sub><b>⚔️ Tactical Reconnaissance Visual:</b> <i>Assault Intercessor Squad deployed in active battlefield engagement</i></sub>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="38%" align="center" valign="middle">
      <img src="assets/art/space-marine-assault_multiview_0.png" alt="Assault Intercessor Squad" width="100%" style="border-radius: 8px; max-height: 320px; object-fit: contain;" />
      <br/>
      <sub><b>StatVault Asset:</b> Primary Tactical Profile</sub>
    </td>
    <td width="62%" valign="top">
      <h3><b>Assault Intercessor Squad</b></h3>
      <p>
      ...
      <i>"Provisional shock infantry profile centred on Heavy Bolt Pistol; retain as unapproved until detailed balance and source review."</i></p>
      <p><b>⚡ Dual-Lens Engine vs Lore Balance:</b><br/>
      • <b>Lore Armor Protection:</b> 265mm RHAe<br/>
      • <b>In-Engine Durability:</b> 1200 HP (Armor Rating: 110)<br/>
      • <b>RTS Tactical Speed:</b> 12.3 mph (19.8 km/h)<br/>
      • <b>Primary Armament:</b> Heavy Bolt Pistol (AP: 24, Base Dmg: 34)<br/>
      • <b>Lore Phenomenon:</b> Assault Intercessor Squad is a Adeptus Astartes shock infantry formation queued for corpus expansion. Temporary static backlog seed; quantit...</p>
    </td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td width="33%" align="center"><sub><b>Front Profile (0°)</b></sub><br/><br/><a href="assets/art/space-marine-assault_multiview_0.png"><img src="assets/art/space-marine-assault_multiview_0.png" width="150" alt="Front Profile" /></a></td>
    <td width="33%" align="center"><sub><b>Flank Profile (90°)</b></sub><br/><br/><a href="assets/art/space-marine-assault_multiview_1.png"><img src="assets/art/space-marine-assault_multiview_1.png" width="150" alt="Flank Profile" /></a></td>
    <td width="33%" align="center"><sub><b>Dorsal Profile (180°)</b></sub><br/><br/><a href="assets/art/space-marine-assault_multiview_2.png"><img src="assets/art/space-marine-assault_multiview_2.png" width="150" alt="Dorsal Profile" /></a></td>
  </tr>
</table>

<table>
  <tr>
    <th colspan="3" align="center">⚔️ Primary Armament Multi-View: Heavy Bolt Pistol</th>
  </tr>
  <tr>
    <td width="33%" align="center"><sub><b>Lateral Aspect</b></sub><br/><br/><a href="assets/art/assault-intercessor-heavy-bolt-pistol_multiview_0.png"><img src="assets/art/assault-intercessor-heavy-bolt-pistol_multiview_0.png" width="90" alt="Weapon View 1" /></a></td>
    <td width="33%" align="center"><sub><b>Dorsal Aspect</b></sub><br/><br/><a href="assets/art/assault-intercessor-heavy-bolt-pistol_multiview_1.png"><img src="assets/art/assault-intercessor-heavy-bolt-pistol_multiview_1.png" width="90" alt="Weapon View 2" /></a></td>
    <td width="33%" align="center"><sub><b>Cutting/Barrel Aspect</b></sub><br/><br/><a href="assets/art/assault-intercessor-heavy-bolt-pistol_multiview_2.png"><img src="assets/art/assault-intercessor-heavy-bolt-pistol_multiview_2.png" width="90" alt="Weapon View 3" /></a></td>
  </tr>
</table>

<p align="center">
  <a href="data/units/space-marine-assault.json"><b>📄 Inspect Unit Dataslate (.json)</b></a> • <a href="data/weapons/assault-intercessor-heavy-bolt-pistol.json"><b>💥 Weapon Specs (.json)</b></a>
</p>
...
```mermaid
flowchart LR
    subgraph EngineLens["⚙️ IN-ENGINE TACTICAL LENS (Warcore RTS)"]
        E1[Raw Game Variables] --> E2[Pathfinding Stability]
        E2 --> E3[Symmetric Counter-Play]
        E3 --> E4[APM Pacing & Spatial Grids]
    end

    subgraph StatVault["🏛️ STATVAULT DUAL-LENS ENGINE"]
        D1[Interactive Calculators]
        D2[6-Axis UPI Radar Vectors]
        D3[Draco/KTX2 3D Viewport]
        D4[Velocity Discrepancy Engine]
    end

    subgraph LoreLens["⚡ CANONICAL LORE LENS (Black Library)"]
        L1[Transhuman Physiology] --> L2[Hypersonic Reflex Arcs]
        L2 --> L3[Transhuman Dread Shock]
        L3 --> L4[Infinite Combat Longevity]
    end

    EngineLens <--> StatVault <--> LoreLens
```
